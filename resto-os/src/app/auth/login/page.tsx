      ...
      <Card className="w-full max-w-md animate-fade-in">
        ...
        <CardContent>
          ...
          <div className="mt-4 space-y-2 text-center text-sm text-muted-foreground">
            <p><a href="/auth/forgot-password" className="text-primary hover:underline">Forgot password?</a></p>
            <p>Don&apos;t have an account?{" "}<a href="/auth/register" className="font-medium text-primary hover:underline">Register</a></p>
          </div>
        </CardContent>
      </Card>
    </div>
